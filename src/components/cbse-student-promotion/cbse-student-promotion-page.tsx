...
export function CbseStudentPromotionPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">CBSE Student Promotion</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Promote CBSE students in bulk from their current class &amp; division into a new class &amp; division for the next academic year.
        </p>
      </div>
